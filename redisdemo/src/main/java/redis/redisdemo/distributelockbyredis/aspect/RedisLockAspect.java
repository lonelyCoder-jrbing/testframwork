package redis.redisdemo.distributelockbyredis.aspect;
...
import redis.redisdemo.distributelockbyredis.constants.RedisConstants;
import redis.redisdemo.distributelockbyredis.exception.RedisLockFailException;
import redis.redisdemo.distributelockbyredis.lock.api.DistributeLock;
import redis.redisdemo.distributelockbyredis.util.RedisLockKeyUtil;
...
public class RedisLockAspect {
    ...
    @Pointcut("@annotation(redis.redisdemo.distributelockbyredis.annotation.RedisLock)")
