package redis.redisdemo.distributelock.aspect;
...
import redis.redisdemo.distributelock.constants.RedisConstants;
import redis.redisdemo.distributelock.exception.RedisLockFailException;
import redis.redisdemo.distributelock.lock.api.DistributeLock;
import redis.redisdemo.distributelock.util.RedisLockKeyUtil;
...
public class RedisLockAspect {
    ...
    @Pointcut("@annotation(redis.redisdemo.distributelock.annotation.RedisLock)")
